		...
		if(len == sizeof(RoutingMsg))
		{
			...
			if(imLeader==FALSE){
				...
				{	
					...
					//call RoutingMsgTimer.startOneShot(TIMER_FAST_PERIOD);
					call NotifyParentMsgTimer.startOneShot(TIMER_PERIOD_MILLI +rand()%60);  // listening  > TIMER_FAST_PERIOD
			...
			{	 
				call RoutingMsgTimer.startOneShot(TIMER_FAST_PERIOD);
				call NotifyParentMsgTimer.startOneShot( TIMER_PERIOD_MILLI + 10*1024 + rand()%60);
			}
		}
	}
