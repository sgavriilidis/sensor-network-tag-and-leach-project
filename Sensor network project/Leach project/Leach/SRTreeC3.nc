...
implementation
{
		...
		event void RoutingMsgTimer.fired()
	{
		...
		if (TOS_NODE_ID==0)
		{
			...
			call RoutingMsgTimer.startOneShot(TIMER_PERIOD_MILLI); //if you are node 0 call NotifyParentMsgTimer to display avg and variance
		}
