...
implementation{
	...
	components new TimerMilliC() as valueGeneratorC;
	components new TimerMilliC() as NotifyParentMsgTimerC;
	components new TimerMilliC() as leaderGeneratorC;
	...
	SRTreeC.valueGenerator->valueGeneratorC;
	SRTreeC.NotifyParentMsgTimer->NotifyParentMsgTimerC;
	SRTreeC.leaderGenerator->leaderGeneratorC;
}
