...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0x7fb8594cacf8, const void *arg_0x7fb8594c9020);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0x7fb859449618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7fb859200020), 
int (*key_eq_fn)(void *arg_0x7fb859200798, void *arg_0x7fb859200a38));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7fb858ffc610, int arg_0x7fb858ffc878);
static double RandomUniform(void );
...
typedef TMilli SRTreeC__leaderGenerator__precision_tag;
...
uint8_t len);
# 83 "/home/tinyos/local/src/tinyos-2x/tos/lib/timer/Timer.nc"
static void SRTreeC__leaderGenerator__fired(void );
# 110 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
...
# 73 "/home/tinyos/local/src/tinyos-2x/tos/lib/timer/Timer.nc"
static void SRTreeC__leaderGenerator__startOneShot(uint32_t dt);
# 80 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
...
#line 47
bool SRTreeC__imLeader[1000];
bool SRTreeC__iwasLeader[1000];
...
double SRTreeC__avg[1000];
double SRTreeC__variance[1000];
...
static inline void SRTreeC__leaderGenerator__fired(void );
#line 136
...
#line 238
  sim_log_debug(69U, "Packet", "Delivering packet to %i at %s\n", (int )sim_node(), sim_time_string());
...
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7fb858c2f908, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7fb858c2f908) {
#line 78
    case 12:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7fb858c2f908, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7fb858c2d480, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7fb858c2d480, msg, payload, len);
#line 78
...
static inline void SimSchedulerBasicP__Scheduler__init(void )
{
  sim_log_debug(56U, "Scheduler", "Initializing scheduler.\n");
  ...
  if (len == sizeof(RoutingMsg )) 
    {
      ...
      if (SRTreeC__imLeader[sim_node()] == FALSE) {
          if (SRTreeC__parentID[sim_node()] < 0 || SRTreeC__parentID[sim_node()] >= 65535) 
            {
              ...
              SRTreeC__NotifyParentMsgTimer__startOneShot(SRTreeC__roundCounter[sim_node()] * TIMER_PERIOD_MILLI + routingTime + rand() % 60);
            }
          else 

            {
              double newparentprob = (double )(rand() / (double )2147483647);
              double tn = 0.2 / 1 - 0.2 * (SRTreeC__roundCounter[sim_node()] % 5);
        ...
        {
          SRTreeC__RoutingMsgTimer__startOneShot(TIMER_PERIOD_MILLI);
          SRTreeC__NotifyParentMsgTimer__startOneShot(SRTreeC__roundCounter[sim_node()] * TIMER_PERIOD_MILLI + routingTime + 200 + rand() % 60);
        }
    }
}
  ...
  if (len == sizeof(NotifyParentMsg )) 
    {
      ...
      if (SRTreeC__imLeader[sim_node()] == TRUE && SRTreeC__iwasLeader[sim_node()] == TRUE) {
        }
      ...
      if (__nesc_ntoh_uint16(mr->parentID.nxdata) == TOS_NODE_ID) 
        {
          ...
          SRTreeC__sum[sim_node()] += __nesc_ntoh_uint16(mr->sum.nxdata);
          SRTreeC__squares[sim_node()] += __nesc_ntoh_uint16(mr->squares.nxdata);
          SRTreeC__children[sim_node()] += __nesc_ntoh_uint16(mr->children.nxdata);


          SRTreeC__avg[sim_node()] = (double )SRTreeC__sum[sim_node()] / (double )SRTreeC__children[sim_node()];
          SRTreeC__variance[sim_node()] = (double )SRTreeC__squares[sim_node()] / (double )SRTreeC__children[sim_node()] - SRTreeC__avg[sim_node()] * SRTreeC__avg[sim_node()];
        }
    }
  else 
...
#line 490
  SRTreeC__sum[sim_node()] += SRTreeC__value[sim_node()];
  SRTreeC__squares[sim_node()] += SRTreeC__value[sim_node()] * SRTreeC__value[sim_node()];
  ...
  if (TOS_NODE_ID == 0) 
    {
      ...
      sim_log_debug(49U, "SRTreeC", "sum   %d   \n", SRTreeC__sum[sim_node()]);
      ...
      sim_log_debug(50U, "SRTreeC", "Average is:%f\n", SRTreeC__avg[sim_node()]);
      sim_log_debug(51U, "SRTreeC", "Variance is:%f\n", SRTreeC__variance[sim_node()]);
      sim_log_debug(52U, "SRTreeC", "ROUND is:%u \n", SRTreeC__roundCounter[sim_node()]);
      sim_log_debug(53U, "SRTreeC", "children is:%d \n\n\n\n", SRTreeC__children[sim_node()]);

      SRTreeC__roundCounter[sim_node()] += 1;
      SRTreeC__sum[sim_node()] = 0;
      SRTreeC__squares[sim_node()] = 0;
      SRTreeC__children[sim_node()] = 1;
...
#line 533
      if (SRTreeC__parentID[sim_node()] == -1) 
        {
          SRTreeC__imLeader[sim_node()] = TRUE;
          SRTreeC__iwasLeader[sim_node()] = FALSE;
      ...
      __nesc_hton_uint16(m->squares.nxdata, SRTreeC__squares[sim_node()]);
      __nesc_hton_uint32(m->average.nxdata, SRTreeC__avg[sim_node()]);
      __nesc_hton_uint32(m->variance.nxdata, SRTreeC__variance[sim_node()]);
...
# 110 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7fb858c306e8, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7fb858c306e8, msg, error);
#line 110
}
#line 110
...
#line 531
  ...
  sim_log_debug(114U, "CpmModelC", "ReadRssi: noise %f\n", noise);
...
# 100 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7fb8586cae18, message_t * msg, error_t error){
#line 100
  switch (arg_0x7fb8586cae18) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7fb8586cae18, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7fb858ed6108){
#line 75
  switch (arg_0x7fb858ed6108) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7fb858ed6108);
#line 75
      break;
#line 75
    }
...
#line 67
# 80 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7fb8586c8020, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7fb8586c8020, addr, msg, len);
#line 80
...
#line 269
  ...
  while (list != (void *)0) {
      sim_log_debug(89U, "CpmModelC", "checkReceive: outstanding from %d\n", list->source);
      count++;
  ...
  sim_log_debug(90U, "CpmModelC", "checkReceive: outstanding count %d noise %lf at %lf\n", count, noise, (double )sim_time() / sim_ticks_per_sec());
...
#line 321
{
  ...
  sim_log_debug(93U, "CpmModelC", "Handling reception event @ %s.\n", sim_time_string());
  while (list != (void *)0) {
      if (list->next == mine) {
          predecessor = list;
        }
...
#line 336
    if (mine == CpmModelC__outstandingReceptionHead[sim_node()]) {
        ...
        sim_log_error(94U, "CpmModelC", "Incoming packet list structure is corrupted: entry is not the head and no entry points to it.\n");
      }
    }
#line 342
  sim_log_debug(95U, "CpmModelC,SNRLoss", "Packet from %i to %i\n", (int )mine->source, (int )sim_node());
  if (!CpmModelC__checkReceive(mine)) {
      sim_log_debug(96U, "CpmModelC,SNRLoss", " - lost packet from %i as SNR was too low.\n", (int )mine->source);
      mine->lost = 1;
    }
...
#line 358
      ...
      sim_log_debug(97U, "CpmModelC,SNRLoss", "-signaling reception\n");
      CpmModelC__Model__receive(mine->msg);
      if (mine->ack) {
          sim_log_debug(98U, "CpmModelC", "yes acknowledgment requested, \n");
        }
      else {
          sim_log_debug(99U, "CpmModelC", "no acknowledgment requested.\n");
        }

      if (mine->ack && CpmModelC__Model__shouldAck(mine->msg)) {
          sim_log_debug(100U, "CpmModelC", " scheduling ack.\n");
          CpmModelC__sim_gain_schedule_ack(mine->source, sim_time() + 1, mine);
        }
      else {
          sim_log_debug(101U, "CpmModelC", " should not ack.\n");
          CpmModelC__free_receive_message(mine);
        }
      ...
      if (RandomUniform() < 0.001) {
          sim_log_debug(102U, "CpmModelC,SNRLoss", "Packet was technically lost, but TOSSIM introduces an ack false positive rate.\n");
          if (mine->ack && CpmModelC__Model__shouldAck(mine->msg)) {
              sim_log_debug_clear(103U, "CpmModelC", " scheduling ack.\n");
              CpmModelC__sim_gain_schedule_ack(mine->source, sim_time() + 1, mine);
            }
          else {
              CpmModelC__free_receive_message(mine);
      ...
      CpmModelC__receiving[sim_node()] = 0;
      sim_log_debug_clear(104U, "CpmModelC,SNRLoss", "  -packet was lost.\n");
    }
}
...
#line 407
  ...
  if (!sim_mote_is_on(sim_node())) {
      sim_log_debug(105U, "CpmModelC", "Lost packet from %i due to %i being off\n", source, sim_node());
      rcv->lost = 1;
    }
  else {
#line 430
    if (!CpmModelC__shouldReceive(power - noiseStr)) {
        sim_log_debug(106U, "CpmModelC,SNRLoss", "Lost packet from %i to %i due to SNR being too low (%i)\n", source, sim_node(), (int )(power - noiseStr));
        rcv->lost = 1;
      }
    else {
#line 434
...
#line 437
        if (CpmModelC__receiving[sim_node()]) {
            sim_log_debug(107U, "CpmModelC,SNRLoss", "Lost packet from %i due to %i being mid-reception\n", source, sim_node());
            rcv->lost = 1;
          }
        else {
#line 441
          if (CpmModelC__transmitting[sim_node()] && rcv->start < CpmModelC__transmissionEndTime[sim_node()] && CpmModelC__transmissionEndTime[sim_node()] <= rcv->end) {
              sim_log_debug(108U, "CpmModelC,SNRLoss", "Lost packet from %i due to %i being mid-transmission, transmissionEndTime %llu\n", source, sim_node(), CpmModelC__transmissionEndTime[sim_node()]);
              rcv->lost = 1;
            }
          else {
...
#line 449
  ...
  while (list != (void *)0) {
      ...
      if (!CpmModelC__shouldReceive(list->power - rcv->power)) {
          sim_log_debug(109U, "Gain,SNRLoss", "Going to lose packet from %i with signal %lf as am receiving a packet from %i with signal %lf\n", list->source, list->power, source, rcv->power);
          list->lost = 1;
        }
      list = list->next;
    }
...
#line 471
  sim_log_debug(110U, "CpmModelC", "Enqueing reception event for %i at %llu with power %lf.\n", dest, endTime, power);
  sim_set_node(dest);
...
#line 480
  ...
  sim_log_debug(111U, "CpmModelC", "Node %i transmitting to %i, finishes at %llu.\n", sim_node(), dest, endTime);
...
#line 487
  ...
  while (list != (void *)0) {
      list->lost = 1;
      sim_log_debug(112U, "CpmModelC,SNRLoss", "Lost packet from %i because %i has outstanding reception, startTime %llu endTime %llu\n", list->source, sim_node(), list->start, list->end);
      list = list->next;
    }
}
...
#line 282
  ...
  sim_log_debug(81U, "TossimPacketModelC", "PACKET: Signaling send done at %llu.\n", sim_time());
...
#line 253
{
  ...
  sim_log_debug(79U, "TossimPacketModelC", "PACKET: Broadcasting packet to everyone.\n");
  ...
  sim_log_debug(80U, "TossimPacketModelC", "PACKET: Send done at %llu.\n", evt->time);
...
#line 500
{
  ...
  sim_log_debug(113U, "CpmModelC", "setPendingTransmission: transmitting %i @ %s\n", CpmModelC__transmitting[sim_node()], sim_time_string());
}
...
#line 243
        TossimPacketModelC__sending[sim_node()] = (void *)0;
        sim_log_debug(78U, "TossimPacketModelC", "PACKET: Failed to send packet due to busy channel.\n");
...
#line 194
  ...
  backoff += sim_csma_init_low();
  backoff *= sim_ticks_per_sec() / sim_csma_symbols_per_sec();
  sim_log_debug(77U, "TossimPacketModelC", "Starting CMSA with %lli.\n", backoff);
...
#line 161
{
  if (!TossimPacketModelC__initialized[sim_node()]) {
      sim_log_error(75U, "TossimPacketModelC", "TossimPacketModelC: Send.send() called, but not initialized!\n");
      return EOFF;
    }
  if (!TossimPacketModelC__running[sim_node()]) {
      sim_log_error(76U, "TossimPacketModelC", "TossimPacketModelC: Send.send() called, but not running!\n");
      return EOFF;
    }
...
#line 244
  sim_log_debug(88U, "CpmModelC,SNR", "SNR is %lf, PRR is %lf\n", SNR, prr_hat);
  if (prr_hat > 1) {
    prr_hat = 1.1;
    }
  else {
...
#line 129
  if (__nesc_ntoh_uint16(header->dest.nxdata) == TossimActiveMessageC__amAddress()) {
      sim_log_debug(68U, "Acks", "Received packet addressed to me so ack it\n");
      return TRUE;
    }
  return FALSE;
}
...
#line 299
      ...
      if (msg != TossimPacketModelC__sending[sim_node()]) {
          ...
          sim_log_debug(82U, "TossimPacketModelC", "Requested ack for 0x%x, but outgoing packet is 0x%x.\n", msg, TossimPacketModelC__sending[sim_node()]);
        }
    }
}
...
#line 162
  sim_log_debug(85U, "CpmModelC,SNRLoss", "SNR is %lf, ARR is %lf\n", SNR, prr_hat);
  if (prr_hat > 1) {
    prr_hat = 1.1;
    }
  else {
...
# 73 "/home/tinyos/local/src/tinyos-2x/tos/lib/timer/Timer.nc"
inline static void SRTreeC__leaderGenerator__startOneShot(uint32_t dt){
#line 73
...
static inline void SRTreeC__leaderGenerator__fired(void )
{
  ...
  if (SRTreeC__iwasLeader[sim_node()] == FALSE) 
    {
      double leader = (double )(rand() / (double )2147483647);
      double tn = 0.25 / 1 - 0.25 * (SRTreeC__roundCounter[sim_node()] % 4);


      if (leader < tn) 
        {
          SRTreeC__imLeader[sim_node()] = TRUE;
          SRTreeC__iwasLeader[sim_node()] = TRUE;
        }
      else 

        {
          SRTreeC__imLeader[sim_node()] = FALSE;
        }
  ...
  SRTreeC__leaderGenerator__startOneShot(TIMER_PERIOD_MILLI);
}
...
# 83 "/home/tinyos/local/src/tinyos-2x/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7fb85877ada0){
#line 83
  switch (arg_0x7fb85877ada0) {
#line 83
    case 0U:
#line 83
...
#line 83
    case 4U:
#line 83
      SRTreeC__leaderGenerator__fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7fb85877ada0);
#line 83
      break;
#line 83
    }
...
#line 45
{
  sim_log_debug(54U, "PlatformC", "Initialized mote.\n");
  return SUCCESS;
}
...
#line 86
{
  sim_log_debug(70U, "TossimPacketModelC", "TossimPacketModelC: Init.init() called\n");
...
#line 169
  ...
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
    {
      SRTreeC__leaderGenerator__startOneShot(TIMER_FAST_PERIOD);
    }
#line 175
    __nesc_atomic_end(__nesc_atomic); }
...
#line 211
  ...
  sim_log_debug(64U, "SimMoteP", "Turning on mote %i at time %s.\n", (int )sim_node(), buf);
...
#line 210
    __nesc_atomic_end(__nesc_atomic); }
  if (result == SUCCESS) {
      sim_log_debug(59U, "Scheduler", "Posting task %hhu.\n", id);
      SimSchedulerBasicP__sim_scheduler_submit_event();
    }
  else {
      sim_log_debug(60U, "Scheduler", "Posting task %hhu, but already posted.\n", id);
    }
  return result;
}
...
#line 75
  ...
  sim_log_debug(55U, "SimMainP", "Mote %li signaling boot at time %s.\n", sim_node(), timeBuf);
  ...
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
    {
      ...
      if (nextTask == SimSchedulerBasicP__NO_TASK) 
        {
          sim_log_debug(57U, "Scheduler", "Told to run next task, but no task to run.\n");
          {
...
#line 193
    __nesc_atomic_end(__nesc_atomic); }
#line 192
  sim_log_debug(58U, "Scheduler", "Running task %hhu.\n", nextTask);
...
static void SRTreeC__NotifyAMSend__sendDone(message_t *msg, error_t err)
{
  ...
  if (!SRTreeC__NotifySendQueue__empty()) 
  ...
  else 
    {
      ...
      SRTreeC__squares[sim_node()] = 0;
      SRTreeC__parentID[sim_node()] = -1;
      if (SRTreeC__roundCounter[sim_node()] % 4 == 0) 
        {
...
#line 78
  sim_log_debug(65U, "AM", "AM: Sending packet (id=%hhu, len=%hhu) to %hu\n", id, len, addr);
...
#line 294
  noise = pow(10.0, noise / 10.0);
  while (list != (void *)0) {
      sim_log_debug(91U, "CpmModelC", "packetReceive: outstanding from %d\n", list->source);
      count++;
  ...
  noise = 10.0 * log(noise) / log(10.0);
  sim_log_debug(92U, "CpmModelC", "packetReceive: outstanding count %d noise %lf at %lf\n", count, noise, (double )sim_time() / sim_ticks_per_sec());
  return noise;
}
...
#line 131
{
  ...
  sim_log_debug(83U, "CpmModelC", "IN: noise_hash_generation()\n");
  ...
  sim_log_debug(84U, "CpmModelC,Tal", "%s: OUT: noise_hash_generation(): %lf\n", sim_time_string(), noise_val);
...
{
  if (!TossimPacketModelC__initialized[sim_node()]) {
      sim_log_error(71U, "TossimPacketModelC", "TossimPacketModelC: Control.start() called before initialization!\n");
      return FAIL;
    }
  sim_log_debug(72U, "TossimPacketModelC", "TossimPacketModelC: Control.start() called.\n");
...
#line 170
  ...
  sim_log_debug(62U, "SimMoteP", "Fetched %s of %i to be %p with len %i (result %i)\n", name, mote, *ptr, *len, result);
  sim_set_node(tmpID);
  return result;
}
...
#line 179
  ...
  sim_log_debug(63U, "SimMoteP", "Setting start time to %llu\n", SimMoteP__startTime[sim_node()]);
  sim_set_node(tmpID);
  return;
}
...
#line 124
{
  if (!SimMoteP__isOn[sim_node()]) {
      ...
      sim_log_debug(61U, "SimMoteP", "Setting start time to %llu\n", SimMoteP__startTime[sim_node()]);
...
{
  /* Module SRTreeC */
  if (!strcmp(varname, "SRTreeC__imLeader"))
  {
    *addr = (uintptr_t)&SRTreeC__imLeader[__nesc_mote];
    *size = sizeof(SRTreeC__imLeader[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SRTreeC__iwasLeader"))
  {
    *addr = (uintptr_t)&SRTreeC__iwasLeader[__nesc_mote];
    *size = sizeof(SRTreeC__iwasLeader[__nesc_mote]);
    return 0;
  }
  ...
  if (!strcmp(varname, "SRTreeC__variance"))
  {
    *addr = (uintptr_t)&SRTreeC__variance[__nesc_mote];
    *size = sizeof(SRTreeC__variance[__nesc_mote]);
    return 0;
  }
...
{
  /* Module SRTreeC */
  SRTreeC__imLeader[__nesc_mote] = FALSE;
  SRTreeC__iwasLeader[__nesc_mote] = FALSE;
  ...
  SRTreeC__avg[__nesc_mote] = 0;
  SRTreeC__variance[__nesc_mote] = 0;
